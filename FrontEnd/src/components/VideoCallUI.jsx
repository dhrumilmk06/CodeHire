...
export const VideoCallUI = ({ chatClient, channel }) => {
  ...
  //useCallCallingState() is for to know the state of the call like joing call, ending call
          ...
          {isChatOpen && (
            <>
              ...
              <div className="flex-1 overflow-hidden stream-chat-dark">
                {/* Adding a key ensures Chat resets if client changes, preventing toISOString errors */}
                <Chat client={chatClient} theme="str-chat__theme-dark" key={chatClient.userID}>
